            ...
            <Column alignItems={"center"} gap="15px">
                <Row justifyContent={"center"} alignItems={"end"} gap={"15px"} breakpoint={1000}>
                    <Column gap="5px">
                        ...
                        <input type="text" id="doctorName" name="nom" placeholder="Nom du docteur" />
                    </Column>
                    <Column gap="5px">
                        <label for="city"><h2 style={{ color: "white", fontWeight: "700" }}>Ville</h2></label>
                        <input type="text" id="city" required name="ville" placeholder="Ville du cabinet du docteur" list="villes" />
                    </Column>
                    <Column gap="5px">
                        <label for="specialty"><h2 style={{ color: "white", fontWeight: "700" }}>Specialité</h2></label>
                        <input type="text" id="specialty" required name="specialite" placeholder="Spécialité du docteur" list="specialites" />
                    </Column>
