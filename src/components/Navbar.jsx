...
function Navbar() {
  ...
  const buttons = [
    { text: "Vous êtes medecin ?", varient: "highlight", href: "/medecin/signup" }
    , { text: "Sign In", varient: "main", href: "/signin" }
    , { text: "Sign Up", varient: "main", href: "/patient/signup" }
  ]

  return (
    <header style={{ height: "fit-content", display: "flex", flexDirection: "row", position: "sticky", top: 0, left: 0, right: 0, padding: "20px" }}>
